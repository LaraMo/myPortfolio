...
export const buttonVariants = tailwindVariants({
  ...
  variants: {
    variant: {
      ...
      "outline-glass":
        "border border-border/70 bg-background/20 text-foreground backdrop-blur-md hover:bg-muted/50 aria-expanded:bg-muted/50 dark:border-white/15 dark:bg-background/15 dark:hover:bg-background/30",
    },
    size: {
      default:
